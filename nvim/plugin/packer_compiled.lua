...
_G.packer_plugins = {
  ...
  ["nvim-web-devicons"] = {
    loaded = false,
    needs_bufread = false,
    path = "/home/jonas/.local/share/nvim/site/pack/packer/opt/nvim-web-devicons",
  ...
  rnvimr = {
    loaded = true,
    path = "/home/jonas/.local/share/nvim/site/pack/packer/start/rnvimr",
    url = "https://github.com/kevinhwang91/rnvimr"
  },
  ["rust-tools.nvim"] = {
    loaded = true,
    path = "/home/jonas/.local/share/nvim/site/pack/packer/start/rust-tools.nvim",
  ...
  ["vim-eunuch"] = {
    loaded = true,
    path = "/home/jonas/.local/share/nvim/site/pack/packer/start/vim-eunuch",
